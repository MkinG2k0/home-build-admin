...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    numbers: Schema.Attribute.Relation<'oneToMany', 'api::number.number'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNumberNumber extends Struct.CollectionTypeSchema {
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::plan.plan'> &
      Schema.Attribute.Private;
    m2: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    residential_complex: Schema.Attribute.Relation<
      'manyToOne',
      'api::residential-complex.residential-complex'
...
export interface ApiResidentialComplexResidentialComplex
  extends Struct.CollectionTypeSchema {
  collectionName: 'residential_complexes';
  info: {
    displayName: 'residential complex';
    pluralName: 'residential-complexes';
    singularName: 'residential-complex';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    complex_documents: Schema.Attribute.Relation<'oneToMany', 'api::doc.doc'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
